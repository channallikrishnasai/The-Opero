"""
Local wake-word detection for OPERO ("Hey opero").
...
CPU. The pretrained wake phrase used here is "Hey opero".
"""
...
# Pretrained openwakeword model that listens for "Hey opero".
WAKE_MODEL = "hey_opero"
...
class WakeWordDetector:
    ...
    def start(self) -> bool:
        ...
        self._thread.start()
        self._logger("Wake word: listening for 'Hey opero'.")
        return True
        ...
        while self._running:
            try:
                ...
                if isinstance(scores, dict):
                    # match the opero model regardless of exact key suffix
