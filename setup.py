...
Two things it deliberately does NOT install:
  * the optional local wake word ("Hey opero") — one-click, opt-in, from
...
def _check_python() -> None:
    ...
    if v > MAX_PY:
        ...
        return
    if v < MIN_PY:
        print(f"\n❌ Python {v[0]}.{v[1]} detected — opero needs at "
...
def main() -> None:
    print(f"⚙  opero setup — detected OS: {OS or 'unknown'}, "
    ...
    print("   3) (Optional) Enable 'Hey opero' from ⚙ → WAKE WORD.")
